...
| cSHAKE-128           | Value to hash, output length bytes, customization bytes | Digest |
| cSHAKE-128/MCT       | Initial seed¹, min output bits, max output bits, output length bits, customization bytes | Digest, output length bits, customization bytes |
